...
POSIZIOA restartPosition(POSIZIOA enemy, int kont, JOKO_ELEMENTUA id1, JOKO_ELEMENTUA id2, JOKO_ELEMENTUA id3, JOKO_ELEMENTUA id4, JOKO_ELEMENTUA id5, JOKO_ELEMENTUA id6, JOKO_ELEMENTUA id7, JOKO_ELEMENTUA id8, JOKO_ELEMENTUA id9, JOKO_ELEMENTUA id10, JOKO_ELEMENTUA id11, JOKO_ELEMENTUA id12, JOKO_ELEMENTUA id13, JOKO_ELEMENTUA id14, JOKO_ELEMENTUA id15, JOKO_ELEMENTUA id16, JOKO_ELEMENTUA id17, JOKO_ELEMENTUA id18, JOKO_ELEMENTUA id19, JOKO_ELEMENTUA id20, JOKO_ELEMENTUA id21, JOKO_ELEMENTUA id22, JOKO_ELEMENTUA id23, JOKO_ELEMENTUA id24, JOKO_ELEMENTUA id25, JOKO_ELEMENTUA id26, JOKO_ELEMENTUA id27, JOKO_ELEMENTUA id28, JOKO_ELEMENTUA id29, JOKO_ELEMENTUA id)
{
	...
	else if (kont == 1) { enemy.x = SCREEN_WIDTH + 1; enemy.y = 440; irudiaMugitu(id1.id, enemy.x, enemy.y); }
	else if (kont == 2) { enemy.x = SCREEN_WIDTH + 1; enemy.y = 440; irudiaMugitu(id1.id, enemy.x, enemy.y); }
	else if (kont == 3) { enemy.x = SCREEN_WIDTH + 1; enemy.y = 440; irudiaMugitu(id1.id, enemy.x, enemy.y); }
	else if (kont == 4) { enemy.x = SCREEN_WIDTH + 1; enemy.y = 440; irudiaMugitu(id1.id, enemy.x, enemy.y); }
	else if (kont == 5) { enemy.x = SCREEN_WIDTH + 1; enemy.y = 440; irudiaMugitu(id1.id, enemy.x, enemy.y); }
	else if (kont == 6) { enemy.x = SCREEN_WIDTH + 1; enemy.y = 440; irudiaMugitu(id1.id, enemy.x, enemy.y); }
	else if (kont == 7) { enemy.x = SCREEN_WIDTH + 1; enemy.y = 440; irudiaMugitu(id1.id, enemy.x, enemy.y); }
	else if (kont == 8) { enemy.x = SCREEN_WIDTH + 1; enemy.y = 440; irudiaMugitu(id1.id, enemy.x, enemy.y); }
	else if (kont == 9) { enemy.x = SCREEN_WIDTH + 1; enemy.y = 440; irudiaMugitu(id1.id, enemy.x, enemy.y); }
	else if (kont == 10) { enemy.x = SCREEN_WIDTH + 1; enemy.y = 440; irudiaMugitu(id1.id, enemy.x, enemy.y); }
	else if (kont == 11) { enemy.x = SCREEN_WIDTH + 1; enemy.y = 440; irudiaMugitu(id1.id, enemy.x, enemy.y); }
	else if (kont == 12) { enemy.x = SCREEN_WIDTH + 1; enemy.y = 440; irudiaMugitu(id1.id, enemy.x, enemy.y); }
	else if (kont == 13) { enemy.x = SCREEN_WIDTH + 1; enemy.y = 440; irudiaMugitu(id1.id, enemy.x, enemy.y); }
	else if (kont == 14) { enemy.x = SCREEN_WIDTH + 1; enemy.y = 440; irudiaMugitu(id1.id, enemy.x, enemy.y); }
	else if (kont == 15) { enemy.x = SCREEN_WIDTH + 1; enemy.y = 440; irudiaMugitu(id1.id, enemy.x, enemy.y); }
	else if (kont == 16) { enemy.x = SCREEN_WIDTH + 1; enemy.y = 440; irudiaMugitu(id1.id, enemy.x, enemy.y); }
	else if (kont == 17) { enemy.x = SCREEN_WIDTH + 1; enemy.y = 440; irudiaMugitu(id1.id, enemy.x, enemy.y); }
	else if (kont == 18) { enemy.x = SCREEN_WIDTH + 1; enemy.y = 440; irudiaMugitu(id1.id, enemy.x, enemy.y); }
	else if (kont == 19) { enemy.x = SCREEN_WIDTH + 1; enemy.y = 440; irudiaMugitu(id1.id, enemy.x, enemy.y); }
	else if (kont == 20) { enemy.x = SCREEN_WIDTH + 1; enemy.y = 440; irudiaMugitu(id1.id, enemy.x, enemy.y); }
	else if (kont == 21) { enemy.x = SCREEN_WIDTH + 1; enemy.y = 440; irudiaMugitu(id1.id, enemy.x, enemy.y); }
	else if (kont == 22) { enemy.x = SCREEN_WIDTH + 1; enemy.y = 440; irudiaMugitu(id1.id, enemy.x, enemy.y); }
	else if (kont == 23) { enemy.x = SCREEN_WIDTH + 1; enemy.y = 440; irudiaMugitu(id1.id, enemy.x, enemy.y); }
	else if (kont == 24) { enemy.x = SCREEN_WIDTH + 1; enemy.y = 440; irudiaMugitu(id1.id, enemy.x, enemy.y); }
	else if (kont == 25) { enemy.x = SCREEN_WIDTH + 1; enemy.y = 440; irudiaMugitu(id1.id, enemy.x, enemy.y); }
	else if (kont == 26) { enemy.x = SCREEN_WIDTH + 1; enemy.y = 440; irudiaMugitu(id1.id, enemy.x, enemy.y); }
	else if (kont == 27) { enemy.x = SCREEN_WIDTH + 1; enemy.y = 440; irudiaMugitu(id1.id, enemy.x, enemy.y); }
	else if (kont == 28) { enemy.x = SCREEN_WIDTH + 1; enemy.y = 440; irudiaMugitu(id1.id, enemy.x, enemy.y); }
	else if (kont == 29) { enemy.x = SCREEN_WIDTH + 1; enemy.y = 440; irudiaMugitu(id1.id, enemy.x, enemy.y); }
	pantailaBerriztu();
	return enemy;
}
...
OLATUAK etsaiak(OLATUAK olatuak, int ebentu, TOWER_STRUCTURE structure, int lifeTotal)
{
	...
	do {
		...
		if (lifeTotal <= 0 || kont1 == 10000 || kont1 == 20000 || kont1 == 27000 || kont1 == 37000 || kont1 == 57000 || kont1 == 77000 || kont1 == 97000 || kont1 == 104000 || kont1 == 124000 || kont1 == 144000 || kont1 == 164000 || kont1 == 184000 || kont1 == 204000 || kont1 == 224000)
		{
			...
			irudiaMugitu(olatuak.P1.id, olatuak.P1.pos.x, olatuak.P1.pos.y);
